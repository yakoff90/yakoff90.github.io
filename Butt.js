(function() {
    ...
    // Кольорові іконки для кнопки play
    var COLOR_PLAY_ICONS = [
        {
            name: 'Play зелена',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#4CAF50"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play синя',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#2196F3"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play червона',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#F44336"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play фіолетова',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#9C27B0"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play помаранчева',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#FF9800"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play рожева',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#E91E63"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play бірюзова',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#00BCD4"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play жовта',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#FFEB3B"/><path d="M10 8L16 12L10 16V8Z" fill="black"/></svg>'
        },
        {
            name: 'Play градієнтна (синьо-зелена)',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="playGrad1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#2196F3"/><stop offset="100%" stop-color="#4CAF50"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#playGrad1)"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play градієнтна (червоно-жовта)',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="playGrad2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#F44336"/><stop offset="100%" stop-color="#FF9800"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#playGrad2)"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play градієнтна (веселка)',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="playGrad3" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#FF6B6B"/><stop offset="33%" stop-color="#4ECDC4"/><stop offset="66%" stop-color="#45B7D1"/><stop offset="100%" stop-color="#96CEB4"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#playGrad3)"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play золота',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#FFD700"/><path d="M10 8L16 12L10 16V8Z" fill="black"/></svg>'
        },
        {
            name: 'Play срібна',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#C0C0C0"/><path d="M10 8L16 12L10 16V8Z" fill="black"/></svg>'
        },
        {
            name: 'Play з ободком (зелена)',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="9" fill="#4CAF50" stroke="white" stroke-width="2"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play з ободком (синя)',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="9" fill="#2196F3" stroke="white" stroke-width="2"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play 3D ефект',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><filter id="shadow3d"><feDropShadow dx="0" dy="2" stdDeviation="2" flood-opacity="0.3"/></filter></defs><circle cx="12" cy="12" r="10" fill="#E91E63" filter="url(#shadow3d)"/><path d="M9 7L17 12L9 17V7Z" fill="white"/></svg>'
        },
        {
            name: 'Play неонова (синя)',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><filter id="neonBlue"><feGaussianBlur stdDeviation="2" result="blur"/><feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><circle cx="12" cy="12" r="10" fill="#00FFFF" filter="url(#neonBlue)"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play неонова (рожева)',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><filter id="neonPink"><feGaussianBlur stdDeviation="2" result="blur"/><feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><circle cx="12" cy="12" r="10" fill="#FF00FF" filter="url(#neonPink)"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play металік',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="metalGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#B0BEC5"/><stop offset="50%" stop-color="#FFFFFF"/><stop offset="100%" stop-color="#B0BEC5"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#metalGrad)"/><path d="M10 8L16 12L10 16V8Z" fill="#37474F"/></svg>'
        },
        {
            name: 'Play з тінню',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="14" cy="14" r="10" fill="#455A64" opacity="0.3"/><circle cx="12" cy="12" r="10" fill="#FF5722"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play мінімалістична',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><path d="M5 3L19 12L5 21V3Z" fill="#FF4081"/></svg>'
        },
        {
            name: 'Play квадратна',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><rect x="2" y="2" width="20" height="20" rx="4" fill="#7E57C2"/><path d="M8 6L18 12L8 18V6Z" fill="white"/></svg>'
        },
        {
            name: 'Play з подвійним колом',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#26A69A"/><circle cx="12" cy="12" r="6" fill="white" opacity="0.3"/><path d="M10 8L16 12L10 16V8Z" fill="white"/></svg>'
        },
        {
            name: 'Play серце',
            html: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" fill="#FF1744"/><path d="M9 8L15 12L9 16V8Z" fill="white"/></svg>'
        }
    ];
    ...
    function collectAllIcons() {
        ...
        // Додаємо кольорові іконки play
        COLOR_PLAY_ICONS.forEach(function(icon, index) {
            addIcon(icon.html, 'color-play-' + index);
        });
