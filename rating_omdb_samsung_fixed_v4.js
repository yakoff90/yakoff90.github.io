(function() {
    ...
    // Стилі
    var style = "<style id=\"maxsm_omdb_rating\">" +".full-start-new__rate-line {display: flex;flex-wrap: nowrap;align-items: center;gap: 0.4em;}" +".full-start-new__rate-line .full-start__rate {font-size: 0.9em;padding: 0.2em 0.4em;border-radius: 0.3em;line-height: 1.2;display: flex;align-items: center;gap: 0.3em;}" +".full-start-new__rate-line .full-start__rate div:first-child {min-width: 1.8em;text-align: center;}" +".full-start-new__rate-line .source--name img,.full-start-new__rate-line .source--name svg {height: 12px !important;width: auto !important;vertical-align: middle;}" +".rate--avg.rating--green  { color: #4caf50; }" +".rate--avg.rating--lime   { color: #3399ff; }" +".rate--avg.rating--orange { color: #ff9933; }" +".rate--avg.rating--red    { color: #f44336; }" +".rate--oscars             { color: gold;    }" +"</style>";
