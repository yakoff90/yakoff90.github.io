        ...
        _createClass(LFUCache, [
            ...
            },
            {
                ...
                value: function restorePlayButtons(e, render) {
                    ...
                    // Очікуємо повного формування DOM
                    setTimeout(function() {
                        // Знаходимо всі кнопки
                        var buttons = render.find('.full-start__button, .button--play, .button--book, .button--reaction, .button--subscribe, .button--options, .view--torrent, .view--trailer');
                        
                        // Для кожної кнопки встановлюємо tabindex для навігації
                        buttons.each(function(index) {
                            var button = $(this);
                            
                            // Встановлюємо tabindex для TV навігації
                            button.attr('tabindex', index + 1);
                            
                            // Додаємо клас для ідентифікації
                            button.addClass('cardify-button');
                            
                            // Видаляємо всі попередні обробники
                            button.off('click').off('keydown');
                            
                            // Додаємо нові обробники
                            button.on('click', function() {
                                _this.handleButtonClick(e, $(this));
                            });
                        ...
                        // Налаштовуємо навігацію між кнопками
                        _this.setupButtonNavigation(buttons);
            ...
            {
                key: "setupButtonNavigation",
                value: function setupButtonNavigation(buttons) {
                    // Налаштовуємо навігацію між кнопками для TV
                    buttons.each(function(index) {
                        var button = $(this);
            ...
            },
            {
                ...
                value: function handlePlayButton(e) {
                    ...
                    if (component && typeof component.start === 'function') {
                        ...
                        // Спробуємо знайти та активувати стандартну кнопку відтворення
                        setTimeout(function() {
                            var nativePlayBtn = $('.full-start__button--play, [data-action="play"]').first();
                            if (nativePlayBtn.length) {
                                nativePlayBtn.trigger('click');
                            } else if (Lampa.Player && typeof Lampa.Player.play === 'function') {
            ...
            },
            {
                ...
                value: function handleTorrentButton(e) {
                    ...
                    // Спробуємо активувати стандартну кнопку торрентів
                    ...
                    if (torrentBtn.length) {
                        ...
                        // Альтернативний спосіб через Activity
                        setTimeout(function() {
                            if (Lampa.Activity && typeof Lampa.Activity.start === 'function') {
                                var card = e.object.card || e.data.movie || e.data.tv;
            ...
            },
            {
                ...
                value: function handleTrailerButton(e) {
                    ...
                    // Перевіряємо, чи вже відтворюється трейлер
                    if (window.cardify_trailer_active) {
                        return;
                    }
                    
                    // Отримуємо дані про трейлер
            ...
            },
            {
                ...
                value: function handleBookmarkButton(e) {
                    ...
                    if (bookmarkBtn.length) {
                        ...
                        Lampa.Noty.show('Додавання до закладок...');
                    }
                }
            },
            {
                ...
                value: function handleReactionButton(e) {
                    ...
                    if (reactionBtn.length) {
                        ...
                        Lampa.Noty.show('Відкриття реакцій...');
                    }
                }
            },
            {
            ...
            },
            {
                ...
                value: function handleOptionsButton(e) {
                    ...
                    if (optionsBtn.length) {
                        ...
                        Lampa.Noty.show('Відкриття опцій...');
                    }
                }
            },
            {
                ...
                value: function getVideoData(e) {
                    // Функція для отримання даних про відео
