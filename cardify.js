        ...
        _createClass(LFUCache, [
            ...
            },
            {
                ...
                value: function skodf(e) {
                    ...
                    // ЗБЕРІГАЄМО СЛОГАН (TAGLINE) - головна зміна
                    var taglineElement = render.find('.full-start-new__tagline');
                    if (!taglineElement.length && e.data && e.data.movie && e.data.movie.tagline) {
                        // Додаємо слоган, якщо його немає
                        var taglineHtml = '<div class="full-start-new__tagline cardify-tagline" style="font-size: 1.1em; color: rgba(255,255,255,0.8); margin: 0.5em 0 1em 0; font-style: italic;">' + 
