        ...
        _createClass(LFUCache, [
            ...
            },
            {
                ...
                value: function skodf(e) {
                    ...
                    // СТВОРЮЄМО ОКРЕМИЙ КОНТЕЙНЕР ДЛЯ СЛОГАНУ, ЯКИЙ НЕ ЗАЛЕЖИТЬ ВІД ІНШИХ ПЛАГІНІВ
                    var taglineContainer = render.find('.cardify__tagline-container');
                    
                    // Видаляємо старий слоган, якщо він є
                    ...
                    if (e.data && e.data.movie && e.data.movie.tagline) {
                        ...
                        if (!taglineContainer.length) {
                            taglineContainer = $('<div class="cardify__tagline-container"></div>');
                            
                            // Додаємо контейнер після заголовка
                            var titleElement = render.find('.full-start-new__title');
                            if (titleElement.length) {
                                titleElement.after(taglineContainer);
                            } else {
                                render.find('.cardify__left').prepend(taglineContainer);
                            }
                        }
                        
                        // Додаємо слоган в контейнер
                        taglineContainer.html('<div class="full-start-new__tagline">' + e.data.movie.tagline + '</div>');
                    }
