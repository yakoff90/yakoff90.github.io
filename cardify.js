        ...
        _createClass(LFUCache, [
            ...
            },
            {
                ...
                value: function skodf(e) {
                    ...
                    // Додаємо опис фільму, якщо він є
                    var description = e.object.activity.render().find('.full-start-new__description');
                    if (!description.length && e.data && e.data.movie && e.data.movie.overview) {
                        var descHtml = '<div class="full-start-new__description cardify-description" style="margin: 1em 0; line-height: 1.4; font-size: 0.95em; color: rgba(255,255,255,0.9); max-width: 80%;">' + 
                                      e.data.movie.overview + '</div>';
                        details.after(descHtml);
                    }
