        ...
        _createClass(LFUCache, [
            ...
            },
            {
                ...
                value: function skodf(e) {
                    ...
                    // ЗБЕРІГАЄМО ОРИГІНАЛЬНИЙ СЛОГАН (TAGLINE)
                    // Шукаємо оригінальний слоган у стандартному шаблоні
                    var originalTagline = render.find('.full-start-new__tagline');
                    
                    // Якщо слоган є, але він прихований через CSS плагіна
                    if (originalTagline.length && originalTagline.is(':hidden')) {
                        // Показуємо його знову
                        originalTagline.show();
                    }
                    
                    // Якщо слоган відсутній у DOM, але є в даних
                    if (!originalTagline.length && e.data && e.data.movie && e.data.movie.tagline) {
                        // Створюємо елемент з класами як у оригіналі
                        var taglineHtml = '<div class="full-start-new__tagline" style="color: rgba(255,255,255,0.8); margin: 0.5em 0 1em 0;">' + 
