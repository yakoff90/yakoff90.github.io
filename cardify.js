        ...
        _createClass(LFUCache, [
            ...
            },
            {
                ...
                value: function skodf(e) {
                    ...
                    // ЗБЕРІГАЄМО ОРИГІНАЛЬНИЙ СЛОГАН (TAGLINE) З НОВИМИ СТИЛЯМИ
                    ...
                    if (originalTagline.length && originalTagline.is(':hidden')) {
                        // Показуємо його знову з новими стилями
                    ...
                    if (!originalTagline.length && e.data && e.data.movie && e.data.movie.tagline) {
                        // Створюємо елемент з класами як у оригіналі та новими стилями
                        var taglineHtml = '<div class="full-start-new__tagline" style="font-size: 1.7em; font-style: italic; color: rgba(255,255,255,0.8); margin: 0.5em 0 1em 0;">' + 
