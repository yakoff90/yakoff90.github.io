(function() {
    ...
    function applyTheme(theme) {
        ...
        var svgCode = encodeURIComponent("<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"135\" height=\"140\" fill=\"".concat(color, "\"><rect width=\"10\" height=\"40\" y=\"100\" rx=\"6\"><animate attributeName=\"height\" begin=\"0s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"40;100;40\" keyTimes=\"0;0.5;1\"/></rect></svg>"));

        var style = $('<style id="maxsm_themes_theme"></style>');
        var themes = {
            mint_dark: "\n.navigation-bar__body {background: rgba(18, 32, 36, 0.96);}\n.card__quality, .card__type::after {background: linear-gradient(to right, #1e6262dd, #3da18ddd);}\n.screensaver__preload {background:url(\"data:image/svg+xml,".concat(svgCode, "\") no-repeat 50% 50%}\n.activity__loader {position:absolute;top:0;left:0;width:100%;height:100%;display:block;background:url(\"data:image/svg+xml,").concat(svgCode, "\") no-repeat 50% 50%}");
