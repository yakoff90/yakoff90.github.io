...
features:
  - icon: "🎵"
    title: "Переименование дорожек"
    description: "Удобное отображение названий аудиодорожек"
  - icon: "📝"
    title: "Переименование субтитров"
    description: "Понятные названия для субтитров"
  - icon: "⚡"
    title: "Быстрый выбор"
    description: "Ускоряет выбор нужной дорожки или субтитра"
requirements:
