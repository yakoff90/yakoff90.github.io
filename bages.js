(function () {
    ...
    try {
        seasonsCache = JSON.parse(Lampa.Storage.get('season_cache_ua_v3', '{}'));
        flagCache = JSON.parse(Lampa.Storage.get('flag_cache_ua_v3', '{}'));
    } catch (e) {}
            ...
            requestQueue.add(function() {
                ...
                Lampa.Network.silent(url, 
                    function(response) {
                        ...
                        try {
                            Lampa.Storage.set('flag_cache_ua_v3', JSON.stringify(flagCache));
                        } catch (e) {}
    ...
    function getSeasonData(tmdbId, callback) {
        ...
        fetch(PROXIES[0] + url)
            ...
            .then(function(data) {
                ...
                try {
                    Lampa.Storage.set('season_cache_ua_v3', JSON.stringify(seasonsCache));
                } catch (e) {}
                callback(data);
            })
    ...
    function start() {
        ...
        Lampa.Noty.show('Плагін "UA Бейджі" завантажено (рейтинг кольоровий, сезон чорний)');
    }
