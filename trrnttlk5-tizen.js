...
// === TIZEN PROXY SUPPORT ===
var IS_TIZEN = typeof Lampa !== 'undefined' && Lampa.Platform && Lampa.Platform.is('tizen');
var TIZEN_PROXY = 'https://lampa-easytorrent-proxy.workers.dev';

function tizenGetConfig(pairCode, callback){
    try{
        var xhr = new XMLHttpRequest();
        xhr.open('GET', TIZEN_PROXY + '/?pairCode=' + encodeURIComponent(pairCode), true);
...
!(function () {
  ...
  function w(e) {
    const t = e.toLowerCase(),
      n = [
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(фильм|film|movie|movies)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(спецвыпуск|special|specials|sp|ova|ona|bonus|extra|экстра|спэшл|спешл|спэшал|ова|она|спэшел)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(трейлер|trailer|teaser|тизер)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(саундтрек|ost|soundtrack)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(клип|clip|pv)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(интервью|interview)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(репортаж|report)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(промо|promo)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(отрывок|preview)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(анонс|announcement)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(съемки|making of|behind the scenes)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(сборник|collection)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(документальный|docu|documentary)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(концерт|concert|live)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /movie\s*\d+/i,
        /film\s*\d+/i,
        /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(мультфильм|аниме-фильм|спецэпизод|спецсерія)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
        /\bepisode of\b/i,
      ];
  ...
  function k(e) {
    const t = (function (e) {
      ...
      n = (function (e) {
        const t =
          /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(?:из|of)\s*(\d{1,4})(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu.exec(
            e,
          );
        if (!t) return null;
        const n = b(t[1]);
    ...
    }
    {
      const e = [
        {
          re: /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(\d{1,2})(?:\s*[-]\s*(\d{1,2}))?\s*сезон(?:а|ы|ів)?(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
          base: 75,
          name: "N сезон",
        },
        {
          re: /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])сезон(?:а|ы|и|ів)?\s*(\d{1,2})(?:\s*[-]\s*(\d{1,2}))?(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
          base: 70,
          name: "Сезон N",
        },
        {
          re: /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])сезон(?:а|ы|и|ів)?\s*:\s*(\d{1,2})(?:\s*[-]\s*(\d{1,2}))?/iu,
          base: 66,
          name: "Сезон: N",
        },
        {
    ...
    }
    {
      const e = [
        {
          re: /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(?:серии|серія|серії|эпизод(?:ы)?|episodes|эп\.?)\s*[: ]?\s*(\d{1,4})(?:\s*[-]\s*(\d{1,4}))?(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
          base: 60,
          name: "серии",
        },
        {
          re: /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(\d{1,4})(?:\s*[-]\s*(\d{1,4}))?\s*(?:серии|серія|серії|эпизод(?:ы)?|эп\.?)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
          base: 62,
          name: "1-4 серии",
        },
        {
          re: /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(\d{1,4})\s*[-]\s*(\d{1,4})\s*серия(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
          base: 62,
          name: "1-4 серия",
        },
        {
          re: /(?:^|[^A-Za-zА-Яа-яІіЇїЄє0-9])(\d{1,4})\s*(?:серия|серія)(?=$|[^A-Za-zА-Яа-яІіЇїЄє0-9])/iu,
          base: 54,
          name: "N серия",
        },
        {
