(function () {
   ...
   * @param {string} key - Ключ у сховища
  ...
  var settings = {
    ...
    translate_tv: true, // завжди увімкнено
    bigbuttons: false   // завжди вимкнено
  };
...
`
  ...
  function initInterfaceModSettingsUI() {
    ...
    // Розмір кнопок (збільшено за замовчуванням)
    add({
      component: 'interface_mod_new',
      param: {
  ...
  /* ============================================================
   * РОЗМІР КНОПОК ТА ІКОНОК (ЗБІЛЬШЕНО)
   * ============================================================ */
  ...
  function getIconSizeForButtonSize() {
    switch (settings.button_size) {
      case 'small':
        return { 
          width: '20', // Збільшено з 18
          height: '20', // Збільшено з 18
          svgWidth: '1.5em', // Збільшено з 1.4em
          svgHeight: '1.5em' // Збільшено з 1.4em
        };
      case 'large':
        return { 
          width: '36', // Збільшено з 32
          height: '36', // Збільшено з 32
          svgWidth: '2.4em', // Збільшено з 2.2em
          svgHeight: '2.4em' // Збільшено з 2.2em
        };
      default: // normal - ЗБІЛЬШЕНО
        return { 
  ...
  function applyButtonSize() {
    ...
    switch (settings.button_size) {
      ...
      case 'large':
        css = `
          .full-start__button, .full-start-new__button {
            min-height: 4.2em !important; /* Збільшено з 3.8em */
            padding: 0.8em 1.6em !important; /* Збільшено з 0.6em 1.4em */
      ...
      default: // normal - ЗБІЛЬШЕНО
        css = `
          .full-start__button, .full-start-new__button {
            min-height: 3.6em !important; /* Збільшено з 3.2em */
            padding: 0.6em 1.4em !important; /* Збільшено з 0.5em 1.2em */
            font-size: 1.1em !important; /* Збільшено з 1em */
          }
          .full-start__button svg, .full-start-new__button svg {
            width: ${iconSize.svgWidth} !important;
            height: ${iconSize.svgHeight} !important;
