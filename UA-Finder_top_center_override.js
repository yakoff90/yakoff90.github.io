...
// === LTF Top-Center Override (non-breaking) ===
try {
  var ltf_override_css = '<style id="ltf_top_center_override">'
    + '.card .card__view{position:relative!important;}'
    + '.card .card__view .card__tracks{top:0!important;left:50%!important;right:auto!important;transform:translateX(-50%)!important;margin-top:0!important;}'
    + '.card .card__view .card__tracks.positioned-below-rating{top:0!important;}'
    + '</style>';
  if (!document.getElementById('ltf_top_center_override')) {
    document.body.insertAdjacentHTML('beforeend', ltf_override_css);
  }
} catch(e) { console && console.warn && console.warn('LTF override inject failed', e); }
// === /LTF Top-Center Override ===
