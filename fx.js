...
window.rch_nws[hostkey].Registry = function RchRegistry(client, startConnection) {
  ...
  function startPlugin() {
    ...
    Lampa.Listener.follow('full', function(e) {
      if (e.type == 'complite') {
        setTimeout(function(){
                $(".view--online_wtch", Lampa.Activity.active().activity.render()).css('color', '#ffeb3b').find('span').text('Філмікс 4К');
        }, 5);
        addButton({
