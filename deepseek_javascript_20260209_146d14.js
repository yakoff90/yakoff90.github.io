...
(function () {
  ...
  // Чекаємо, поки Lampa буде доступна
  ...
  waitForLampa(function() {
    ...
    function loadSettings() {
      try {
        ...
        console.error('Studio logos: Error loading settings', e);
      }
    }
    ...
    function saveSettings() {
      try {
        ...
        console.error('Studio logos: Error saving settings', e);
      }
    }
    ...
    function processCards() {
      try {
        ...
        console.error('Studio logos: Error processing cards', e);
      }
    }
    ...
    function processDetails(movie) {
      try {
        ...
        console.error('Studio logos: Error processing details', e);
      }
    }
    ...
    function openSettings() {
      ...
      if (Lampa.SettingsApi && Lampa.SettingsApi.open) {
    ...
    function init() {
      ...
      var style = '<style>\
        ...
        \
        .card-logo { \
          animation: studio_logo_in 0.3s ease forwards 0.1s; \
        }\
        \
      ...
      try {
        ...
        console.error('Studio logos: Error adding settings menu', e);
      }
