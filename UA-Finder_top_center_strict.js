...
var styleTracks = "<style id=\"lampa_tracks_styles\">" +
    ...
    " top: 0 !important; " + // Чітко у самого верху
    " left: 50% !important; " + // По центру горизонтально
    " transform: translateX(-50%) !important; " + // Точне центрування
    " background: rgba(0,0,0,0.55) !important;" + // Трохи щільніший фон
    ...
    "}" +
    "
.card__view .card__tracks.positioned-below-rating { top: 0 !important; }
</style>";
    ...
    if (parentCard) {
        ...
        if (voteElement) {
             ...
             if (topStyle !== 'auto' && parseInt(topStyle) < 100) {
                 /* disabled: positioned-below-rating */
             }
        }
    }
