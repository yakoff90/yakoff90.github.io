(function () {
    ...
    waitForLampa(function() {
        ...
        function getWideStyles() {
            var styles = '';
            styles += '.items-line__title .full-person__photo {';
            styles += '    width: 1.8em !important;';
            styles += '    height: 1.8em !important;';
            styles += '}';
            styles += '.items-line__title .full-person--svg .full-person__photo {';
            styles += '    padding: 0.5em !important;';
            styles += '    margin-right: 0.5em !important;';
            styles += '}';
            styles += '.items-line__title .full-person__photo {';
            styles += '    margin-right: 0.5em !important;';
            styles += '}';
            styles += '.items-line {';
            styles += '    padding-bottom: 4em !important;';
            styles += '}';
            styles += '.new-interface-info__head, .new-interface-info__details{ opacity: 0; transition: opacity 0.5s ease; min-height: 2.2em !important;}';
            styles += '.new-interface-info__head.visible, .new-interface-info__details.visible{ opacity: 1; }';
            styles += '.new-interface .card.card--wide {';
            styles += '    width: 18.3em;';
            styles += '}';
            styles += '.new-interface .card.card--small {';
            styles += '    width: 18.3em;';
            styles += '}';
            styles += '.new-interface-info {';
            styles += '    position: relative;';
            styles += '    padding: 1.5em;';
            styles += '    height: 27.5em;';
            styles += '}';
            styles += '.new-interface-info__body {';
            styles += '    position: absolute;';
            styles += '    z-index: 9999999;';
            styles += '    width: 80%;';
            styles += '    padding-top: 1.1em;';
            styles += '}';
            styles += '.new-interface-info__head {';
            styles += '    color: rgba(255, 255, 255, 0.6);';
            styles += '    font-size: 1.3em;';
            styles += '    min-height: 1em;';
            styles += '}';
            styles += '.new-interface-info__head span {';
            styles += '    color: #fff;';
            styles += '}';
            styles += '.new-interface-info__title {';
            styles += '    font-size: 4em;';
            styles += '    font-weight: 600;';
            styles += '    margin-bottom: 0.3em;';
            styles += '    overflow: hidden;';
            styles += '    -o-text-overflow: \'.\';';
            styles += '    text-overflow: \'.\';';
            styles += '    display: -webkit-box;';
            styles += '    -webkit-line-clamp: 1;';
            styles += '    line-clamp: 1;';
            styles += '    -webkit-box-orient: vertical;';
            styles += '    margin-left: -0.03em;';
            styles += '    line-height: 1.3;';
            styles += '}';
            styles += '.new-interface-info__details {';
            styles += '    margin-top: 1.2em;';
            styles += '    margin-bottom: 1.6em;';
            styles += '    display: flex;';
            styles += '    align-items: center;';
            styles += '    flex-wrap: wrap;';
            styles += '    min-height: 1.9em;';
            styles += '    font-size: 1.3em;';
            styles += '}';
            styles += '.new-interface-info__split {';
            styles += '    margin: 0 1em;';
            styles += '    font-size: 0.7em;';
            styles += '}';
            styles += '.new-interface-info__description {';
            styles += '    font-size: 1.4em;';
            styles += '    font-weight: 310;';
            styles += '    line-height: 1.3;';
            styles += '    overflow: hidden;';
            styles += '    -o-text-overflow: \'.\';';
            styles += '    text-overflow: \'.\';';
            ...
            styles += '    width: 65%;';
            styles += '}';
            styles += '.new-interface .card-more__box {';
            styles += '    padding-bottom: 95%;';
            styles += '}';
            styles += '.new-interface .full-start__background-wrapper {';
            styles += '    position: absolute;';
            styles += '    top: 0;';
            styles += '    left: 0;';
            styles += '    width: 100%;';
            ...
            styles += '}';
            styles += '.new-interface .full-start__background {';
            styles += '    position: absolute;';
            styles += '    height: 108%;';
            styles += '    width: 100%;';
            styles += '    top: -5em;';
            ...
            styles += '    transition: opacity 0.8s cubic-bezier(0.4, 0, 0.2, 1);';
            styles += '}';
            styles += '.new-interface .full-start__background.active {';
            styles += '    opacity: 0.5;';
            styles += '}';
            styles += '.new-interface .full-start__rate {';
            styles += '    font-size: 1.3em;';
            styles += '    margin-right: 0;';
            styles += '}';
            styles += '.new-interface .card__promo {';
            styles += '    display: none;';
            styles += '}';
            styles += '.new-interface .card.card--wide + .card-more .card-more__box {';
            styles += '    padding-bottom: 95%;';
            styles += '}';
            styles += '.new-interface .card.card--wide .card-watched {';
            styles += '    display: none !important;';
            styles += '}';
            styles += 'body.light--version .new-interface-info__body {';
            styles += '    position: absolute;';
            styles += '    z-index: 9999999;';
            styles += '    width: 69%;';
            styles += '    padding-top: 1.5em;';
            styles += '}';
            styles += 'body.light--version .new-interface-info {';
            styles += '    height: 25.3em;';
            styles += '}';
            styles += 'body.advanced--animation:not(.no--animation) .new-interface .card.card--wide.focus .card__view {';
            styles += '    animation: animation-card-focus 0.2s;';
            styles += '}';
            styles += 'body.advanced--animation:not(.no--animation) .new-interface .card.card--wide.animate-trigger-enter .card__view {';
            styles += '    animation: animation-trigger-enter 0.2s forwards;';
            styles += '}';
            styles += 'body.advanced--animation:not(.no--animation) .new-interface .card.card--small.focus .card__view {';
            styles += '    animation: animation-card-focus 0.2s;';
            styles += '}';
            styles += 'body.advanced--animation:not(.no--animation) .new-interface .card.card--small.animate-trigger-enter .card__view {';
            styles += '    animation: animation-trigger-enter 0.2s forwards;';
            styles += '}';
            styles += '.logo-moved-head { transition: opacity 0.4s ease; }';
            styles += '.logo-moved-separator { transition: opacity 0.4s ease; }';
            
            // Samsung TV оптимізації
            styles += '.samsung-tv .card__view {';
            styles += '    transform: translate3d(0,0,0);';
            styles += '    -webkit-transform: translate3d(0,0,0);';
            styles += '    backface-visibility: hidden;';
            styles += '    -webkit-backface-visibility: hidden;';
            styles += '}';
            styles += '.samsung-tv .items-line {';
            styles += '    transform: translate3d(0,0,0);';
            styles += '    -webkit-transform: translate3d(0,0,0);';
            styles += '}';
            styles += '.samsung-tv .card {';
            styles += '    transform: translate3d(0,0,0);';
            styles += '    -webkit-transform: translate3d(0,0,0);';
            styles += '}';
            styles += '.samsung-tv .new-interface-info {';
            styles += '    transform: translate3d(0,0,0);';
            styles += '    -webkit-transform: translate3d(0,0,0);';
            styles += '}';
            styles += '.samsung-tv img {';
            styles += '    image-rendering: -webkit-optimize-contrast;';
            styles += '    image-rendering: optimizeQuality;';
            styles += '}';
            styles += '.samsung-tv * {';
            ...
            // Медіа-запити для TV
            styles += '@media (max-width: 1920px) {';
            styles += '    .samsung-tv .card.card--wide,';
            styles += '    .samsung-tv .card.card--small {';
            styles += '        width: 16.3em;';
            styles += '    }';
            styles += '}';
            styles += '@media (max-width: 1600px) {';
            styles += '    .samsung-tv .card.card--wide,';
            styles += '    .samsung-tv .card.card--small {';
            styles += '        width: 14.3em;';
            styles += '    }';
            styles += '}';
            styles += '@media (max-width: 1366px) {';
            styles += '    .samsung-tv .card.card--wide,';
            styles += '    .samsung-tv .card.card--small {';
            styles += '        width: 12.3em;';
            styles += '    }';
        ...
        function getSmallStyles() {
            ...
            styles += '    position: relative;';
            styles += '    padding: 1.5em;';
            styles += '    height: 19.8em;';
            styles += '}';
            styles += '.new-interface-info__body {';
            styles += '    position: absolute;';
            styles += '    z-index: 9999999;';
            styles += '    width: 80%;';
            styles += '    padding-top: 0.2em;';
            styles += '}';
            styles += '.new-interface-info__head {';
            styles += '    color: rgba(255, 255, 255, 0.6);';
            styles += '    margin-bottom: 0.3em;';
            ...
            styles += '    text-overflow: \'.\';';
            styles += '    display: -webkit-box;';
            styles += '    -webkit-line-clamp: 2;';
            styles += '    line-clamp: 2;';
            styles += '    -webkit-box-orient: vertical;';
            styles += '    width: 70%;';
            styles += '}';
            styles += '.new-interface .card-more__box {';
            styles += '    padding-bottom: 150%;';
            styles += '}';
            styles += '.new-interface .full-start__background-wrapper {';
            styles += '    position: absolute;';
            styles += '    top: 0;';
        ...
        InfoPanel.prototype.create = function () {
            this.html = $('<div class="new-interface-info"><div class="new-interface-info__body"><div class="new-interface-info__head"></div><div class="new-interface-info__title"></div><div class="new-interface-info__details"></div><div class="new-interface-info__description"></div></div></div>');
        };
