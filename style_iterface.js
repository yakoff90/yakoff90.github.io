(function () {
    ...
    // Додаємо підтримку для Samsung TV
    ...
    function shouldEnableInterface(object) {
        ...
        if (object.title === "Обране") return false; // Українська мова
        return true;
    }
    ...
    function initializeSettings() {
            ...
            if (event.name == "main") {
                if (Lampa.Settings.main().render().find('[data-component="style_interface"]').length == 0) {
                    Lampa.SettingsApi.addComponent({
                        ...
                        name: "Стильний інтерфейс", // Українська мова
                    });
                }
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: "Стильний інтерфейс", // Українська мова
                description: "Налаштування елементів", // Українська мова
            },
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Показувати логотип замість назви", // Українська мова
                description: "Відображати логотип фільму/серіалу замість текстової назви" // Українська мова
            },
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Відображати постери на фоні", // Українська мова
                description: "Показувати фонове зображення при виборі картки" // Українська мова
            },
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Показувати статус фільму/серіалу", // Українська мова
                description: "Відображати статус (випущено, онґоїнг тощо)" // Українська мова
            },
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Показувати кількість сезонів", // Українська мова
                description: "Відображати загальну кількість сезонів для серіалів" // Українська мова
            },
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Показувати кількість епізодів", // Українська мова
                description: "Відображати загальну кількість епізодів для серіалів" // Українська мова
            },
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Показувати вікове обмеження", // Українська мова
                description: "Відображати віковий рейтинг (16+, 18+ тощо)" // Українська мова
            },
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Показувати тривалість фільму", // Українська мова
                description: "Відображати час тривалості фільму" // Українська мова
            },
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Показувати жанр фільму", // Українська мова
                description: "Відображати жанри фільму або серіалу" // Українська мова
            },
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Показувати рейтинг фільму", // Українська мова
                description: "Відображати рейтинг TMDB" // Українська мова
            },
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Кольорові рейтинги", // Українська мова
                description: "Забарвлювати рейтинги залежно від значення" // Українська мова
            },
            onChange: function (value) {
                if (value) {
                    siStyleUpdateVoteColors();
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Обводка рейтингів", // Українська мова
                description: "Додавати рамку навколо рейтингів" // Українська мова
            },
            onChange: function (value) {
                siStyleUpdateVoteColors();
            },
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Дитячий режим", // Українська мова
                description: "Фільтрувати контент для дітей (Lampa буде перезавантажена)" // Українська мова
            },
            onChange: function () {
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Включити асинхронне завантаження даних", // Українська мова
                description: "Попереднє завантаження інформації про картки" // Українська мова
            },
            onChange: function (value) {
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Роздільна здатність фону", // Українська мова
                description: "Якість завантажуваних фонових зображень" // Українська мова
            },
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Приховувати назви та рік", // Українська мова
                description: "Не показувати назви та рік на картках (Lampa буде перезавантажена)" // Українська мова
            },
            onChange: function () {
                window.location.reload();
            },
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Широкі постери", // Українська мова
                description: "Використовувати широкі постера замість маленьких (Lampa буде перезавантажена)" // Українська мова
            },
            onChange: function () {
                window.location.reload();
            },
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { 
                name: "Очистити кеш логотипів", // Українська мова
                description: "Видалити збережені логотипи (Lampa буде перезавантажена)" // Українська мова
            },
            onRender: function (item) {
                item.on("hover:enter", function () {
                    Lampa.Select.show({
                        title: "Очистити кеш логотипів?", // Українська мова
                        items: [{ title: "Так", confirm: true }, { title: "Ні" }], // Українська мова
                        onSelect: function (a) {
                            if (a.confirm) {
                                var keys = [];
